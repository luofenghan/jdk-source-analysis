...
public class File implements Serializable, Comparable<File> {
    ...
    public boolean canRead() {
        ...
        return !isInvalid() && fs.checkAccess(this, FileSystem.ACCESS_READ);
    }
    ...
    public boolean canWrite() {
        ...
        return !isInvalid() && fs.checkAccess(this, FileSystem.ACCESS_WRITE);
    }
    ...
    public boolean exists() {
        ...
        return !isInvalid() && ((fs.getBooleanAttributes(this) & FileSystem.BA_EXISTS) != 0);
    }
    ...
    public boolean isDirectory() {
        ...
        return !isInvalid() && ((fs.getBooleanAttributes(this) & FileSystem.BA_DIRECTORY) != 0);
    }
    ...
    public boolean isFile() {
        ...
        return !isInvalid() && ((fs.getBooleanAttributes(this) & FileSystem.BA_REGULAR) != 0);
    }
    ...
    public boolean isHidden() {
        ...
        return !isInvalid() && ((fs.getBooleanAttributes(this) & FileSystem.BA_HIDDEN) != 0);
    }
    ...
    public boolean delete() {
        ...
        return !isInvalid() && fs.delete(this);
    }
    ...
    public boolean mkdir() {
        ...
        return !isInvalid() && fs.createDirectory(this);
    }
    ...
    public boolean renameTo(File dest) {
        ...
        return !(this.isInvalid() || dest.isInvalid()) && fs.rename(this, dest);
    }
    ...
    public boolean setLastModified(long time) {
        ...
        return !isInvalid() && fs.setLastModifiedTime(this, time);
    }
    ...
    public boolean setReadOnly() {
        ...
        return !isInvalid() && fs.setReadOnly(this);
    }
    ...
    public boolean setWritable(boolean writable, boolean ownerOnly) {
        ...
        return !isInvalid() && fs.setPermission(this, FileSystem.ACCESS_WRITE, writable, ownerOnly);
    }
    ...
    public boolean setReadable(boolean readable, boolean ownerOnly) {
        ...
        return !isInvalid() && fs.setPermission(this, FileSystem.ACCESS_READ, readable, ownerOnly);
    }
    ...
    public boolean setExecutable(boolean executable, boolean ownerOnly) {
        ...
        return !isInvalid() && fs.setPermission(this, FileSystem.ACCESS_EXECUTE, executable, ownerOnly);
    }
    ...
    public boolean canExecute() {
        ...
        return !isInvalid() && fs.checkAccess(this, FileSystem.ACCESS_EXECUTE);
    }
