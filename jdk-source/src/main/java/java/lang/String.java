...
public final class String implements java.io.Serializable, Comparable<String>, CharSequence {
    ...
    /**
     * String类是一个使用【序列化流协议】的特殊包装
     * 根据规范《platform/serialization/spec/output.html Object Serialization Specification, Section 6.2, "Stream Elements"》
     * 一个String 实例 会被写入 ObjectOutputStream
     */
    private static final ObjectStreamField[] serialPersistentFields = new ObjectStreamField[0];

    /**
     * 初始化一个新的String对象，用于代表一个空字符序列。
     * 注意,使用这种构造函数是没有必要的,因为字符串是不可变的。
     */
    public String() {
        this.value = "".value;
    }
     ...
     * 初始化一个新的String对象，用于代表一个相同的字符串序列。
     * 换句话说，这个新创建的字符串是参数字符串的一个副本。
     *
    ...
    public boolean regionMatches(boolean ignoreCase, int toffset,
        ...
        while (len-- > 0) {
            ...
            if (ignoreCase) {
                ...
                /*不幸的是，对于 Georgian alphabet 来说，转化成大写可能没有效果，因为它的大小转换有着奇怪的规则*/
                /*因此需要准换成小写进行比较*/
