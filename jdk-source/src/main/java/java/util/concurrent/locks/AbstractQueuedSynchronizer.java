...
public abstract class AbstractQueuedSynchronizer extends AbstractOwnableSynchronizer implements Serializable {
    ...
    static final class Node {
         ...
         * 节点状态需要向后传播
         * 某个releaseShared应该被传播非其他节点。
         * 该设置用于在doReleaseShared操作中确保传播的继续进行
         */
    ...
    public final void acquire(int arg) {
        // 如果获取到锁，tryAcquire返回true，反之，返回false
     ...
     * 该数字用于在 纳秒 时间内自旋，比挂起的时间要快的多
     * 一个粗略的估计，可以在短时间内改善响应能力
     */
    ...
    /**
     * 如果通过tryAcquire没有获取到锁，那么将当前线程放到队列中去
     *
    ...
    private void unparkSuccessor(Node node) {
        ...
        /*
         * 一个情况下唤醒的线程是【头结点】的【下一个节点】
         * 但是如果该节点被取消或者为null，
         * 那么需要【从后往前遍历】寻找一个【最早的】、【没有被取消】的节点
         */
        Node s = node.next;
    ...
    private static boolean shouldParkAfterFailedAcquire(Node pred, Node node) {
        ...
        if (ws > 0) {
             ...
             * 调用者需要再次尝试在挂起之前能不能获取到锁，
             * 因此，将当前pred的状态设为SIGNAL，再次尝试获取之后还没有得到锁那么挂起
             *
             */
    ...
    private final boolean parkAndCheckInterrupt() {
        ...
        /*如果被中断，则返回true，接着中断状态被取消，变为false*/
